...
| Model | State |
|---|---|
| https://github.com/biodatamodels/gff-schema | Self-described DRAFT. Last commit 2021-06-03. Ten commits, all from a single contributor. One open issue, number 1, from 2021-02-11 |

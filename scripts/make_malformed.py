...
file by mistake:
    ...
    corpus/fixtures/malformed/    six files that violate the GFF3 specification
...
real producer emits, and corpus/index.yaml labels them that way.
...
SRC_REL = "corpus/sources/ncbi-refseq/ncbi_refseq_phix174_GCF_000819615.1.gff"
SRC = os.path.join(ROOT, SRC_REL)
BAD = os.path.join(ROOT, "corpus/fixtures/malformed")
EDGE = os.path.join(ROOT, "corpus/fixtures/edge-cases")

TRAILER = (
    "# derived-from: {src}\n"
    "# single-change: {change}\n"
    "# validity: {validity}\n"
    "# note: generated by scripts/make_malformed.py; see corpus/index.yaml\n"
)
